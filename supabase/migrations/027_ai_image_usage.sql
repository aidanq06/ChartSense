-- Image analysis daily usage tracking and RPC
...
create index if not exists idx_image_analysis_usage_daily_user
  on public.image_analysis_usage_daily(user_id);
...
-- RPC to increment image analysis usage atomically
...
grant execute on function public.increment_image_analysis_usage(uuid, integer)
